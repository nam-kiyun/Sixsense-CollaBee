...
@ElDto(FldYn = "", delimeterYn = "", logicalName = "버전 조회 사용")
public class TaskVersionSearchVo extends com.demo.proworks.cmmn.ProworksCommVO {
    private static final long serialVersionUID = 1L;

    public TaskVersionSearchVo(){
    }

package com.demo.proworks.manager.service.impl;
...
/**  
 * @subject     : 업무 담당자 정보 관련 처리를 담당하는 ServiceImpl
 * @description	: 업무 담당자 정보 관련 처리를 담당하는 ServiceImpl
 * @author      : 국다인
 * @since       : 2025/07/01
 * @modification
 * ===========================================================
...
public class ManagerServiceImpl implements ManagerService {
     ...
     *
     * @process
     * 1. 업무 담당자 정보 페이징 처리하여 목록을 조회한다.
     * 2. 결과 List<ManagerVo>을(를) 리턴한다.
     * 
     * @param  managerVo 업무 담당자 정보 ManagerVo
     * @return 업무 담당자 정보 목록 List<ManagerVo>
     * @throws Exception
     */
    ...
    /**
     * 조회한 업무 담당자 정보 전체 카운트
     *
     * @process
     * 1. 업무 담당자 정보 조회하여 전체 카운트를 리턴한다.
     * 
     * @param  managerVo 업무 담당자 정보 ManagerVo
     * @return 업무 담당자 정보 목록 전체 카운트
     * @throws Exception
     */

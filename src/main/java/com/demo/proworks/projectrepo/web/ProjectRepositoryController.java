package com.demo.proworks.projectrepo.web;
...
import com.demo.proworks.projectrepo.vo.ProjectRepositoryListVo;
...
/**  
 * @subject     : 프로젝트와 연결된 레포지토리 정보 관련 처리를 담당하는 컨트롤러
 * @description : 프로젝트와 연결된 레포지토리 정보 관련 처리를 담당하는 컨트롤러
 * @author      : 남기윤
 * @since       : 2025/07/01
 * @modification
 * ===========================================================
...
public class ProjectRepositoryController {
    ...
    @ElDescription(sub="프로젝트와 연결된 레포지토리 정보 목록조회",desc="페이징을 처리하여 프로젝트와 연결된 레포지토리 정보 목록 조회를 한다.")               
    ...
    /**
     * 프로젝트와 연결된 레포지토리 정보을 단건 조회 처리 한다.
     *
     * @param  projectRepositoryVo 프로젝트와 연결된 레포지토리 정보
     * @return 단건 조회 결과
     * @throws Exception
    ...
    @ElDescription(sub = "프로젝트와 연결된 레포지토리 정보 갱신 폼을 위한 조회", desc = "프로젝트와 연결된 레포지토리 정보 갱신 폼을 위한 조회를 한다.")    
    ...
    @ElDescription(sub="프로젝트와 연결된 레포지토리 정보 등록처리",desc="프로젝트와 연결된 레포지토리 정보를 등록 처리 한다.")
    ...
    @ElDescription(sub="프로젝트와 연결된 레포지토리 정보 갱신처리",desc="프로젝트와 연결된 레포지토리 정보를 갱신 처리 한다.")    
    ...
    @ElDescription(sub = "프로젝트와 연결된 레포지토리 정보 삭제처리", desc = "프로젝트와 연결된 레포지토리 정보를 삭제 처리한다.")    

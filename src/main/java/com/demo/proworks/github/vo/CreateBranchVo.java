...
@ElDto(FldYn = "", delimeterYn = "", logicalName = "브랜치 생성용 파라마티 VO")
public class CreateBranchVo extends com.demo.proworks.cmmn.ProworksCommVO {
    private static final long serialVersionUID = 1L;

    public CreateBranchVo(){
    }

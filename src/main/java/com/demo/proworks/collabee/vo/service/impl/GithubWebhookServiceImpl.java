...
/**  
 * @subject     : 깃허브_웹훅 관련 처리를 담당하는 ServiceImpl
 * @description	: 깃허브_웹훅 관련 처리를 담당하는 ServiceImpl
 * @author      : 남기윤
 * @since       : 2025/06/30
 * @modification
 * ===========================================================
...
public class GithubWebhookServiceImpl implements GithubWebhookService {
     ...
     *
     * @process
     * 1. 깃허브_웹훅 페이징 처리하여 목록을 조회한다.
     * 2. 결과 List<GithubWebhookVo>을(를) 리턴한다.
     * 
     * @param  githubWebhookVo 깃허브_웹훅 GithubWebhookVo
     * @return 깃허브_웹훅 목록 List<GithubWebhookVo>
     * @throws Exception
     */
     ...
     *
     * @process
     * 1. 깃허브_웹훅 조회하여 전체 카운트를 리턴한다.
     * 
     * @param  githubWebhookVo 깃허브_웹훅 GithubWebhookVo
     * @return 깃허브_웹훅 목록 전체 카운트
     * @throws Exception
     */

...
import com.demo.proworks.collabee.vo.dao.ProjectDAO;
...
public class ProjectDAO extends com.demo.proworks.cmmn.dao.ProworksDefaultAbstractDAO {
    ...
    public ProjectVo selectProject(ProjectVo vo) throws ElException {
        return (ProjectVo) selectByPk("com.demo.proworks.collabee.vo.selectProject", vo);
    }
    ...
    public List<ProjectVo> selectListProject(ProjectVo vo) throws ElException {      	
        return (List<ProjectVo>)list("com.demo.proworks.collabee.vo.selectListProject", vo);
    }
    ...
    public long selectListCountProject(ProjectVo vo)  throws ElException{               
        return (Long)selectByPk("com.demo.proworks.collabee.vo.selectListCountProject", vo);
    }
    ...
    public int insertProject(ProjectVo vo) throws ElException {    	
        return insert("com.demo.proworks.collabee.vo.insertProject", vo);
    }
    ...
    public int updateProject(ProjectVo vo) throws ElException {
        return update("com.demo.proworks.collabee.vo.updateProject", vo);
    }
    ...
    public int deleteProject(ProjectVo vo) throws ElException {
        return delete("com.demo.proworks.collabee.vo.deleteProject", vo);
    }

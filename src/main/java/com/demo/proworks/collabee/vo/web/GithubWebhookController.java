...
import com.demo.proworks.collabee.vo.service.GithubWebhookService;
import com.demo.proworks.collabee.vo.vo.GithubWebhookVo;
import com.demo.proworks.collabee.vo.vo.GithubWebhookListVo;
...
/**  
 * @subject     : 깃허브_웹훅 관련 처리를 담당하는 컨트롤러
 * @description : 깃허브_웹훅 관련 처리를 담당하는 컨트롤러
 * @author      : 남기윤
 * @since       : 2025/06/30
 * @modification
 * ===========================================================
...
public class GithubWebhookController {
    ...
    @ElDescription(sub="깃허브_웹훅 목록조회",desc="페이징을 처리하여 깃허브_웹훅 목록 조회를 한다.")               
    ...
    @ElDescription(sub = "깃허브_웹훅 갱신 폼을 위한 조회", desc = "깃허브_웹훅 갱신 폼을 위한 조회를 한다.")    
    ...
    @ElDescription(sub="깃허브_웹훅 등록처리",desc="깃허브_웹훅를 등록 처리 한다.")
    ...
    @ElDescription(sub="깃허브_웹훅 갱신처리",desc="깃허브_웹훅를 갱신 처리 한다.")    
    ...
    @ElDescription(sub = "깃허브_웹훅 삭제처리", desc = "깃허브_웹훅를 삭제 처리한다.")    

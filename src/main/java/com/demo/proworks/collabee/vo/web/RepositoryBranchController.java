...
import com.demo.proworks.collabee.vo.vo.RepositoryBranchListVo;
...
/**  
 * @subject     : 연결된레포지토리브랜치 관련 처리를 담당하는 컨트롤러
 * @description : 연결된레포지토리브랜치 관련 처리를 담당하는 컨트롤러
 * @author      : 남기윤
 * @since       : 2025/07/01
 * @modification
 * ===========================================================
...
public class RepositoryBranchController {
    ...
    @ElDescription(sub="연결된레포지토리브랜치 목록조회",desc="페이징을 처리하여 연결된레포지토리브랜치 목록 조회를 한다.")               
    ...
    @ElDescription(sub = "연결된레포지토리브랜치 갱신 폼을 위한 조회", desc = "연결된레포지토리브랜치 갱신 폼을 위한 조회를 한다.")    
    ...
    @ElDescription(sub="연결된레포지토리브랜치 등록처리",desc="연결된레포지토리브랜치를 등록 처리 한다.")
    ...
    @ElDescription(sub="연결된레포지토리브랜치 갱신처리",desc="연결된레포지토리브랜치를 갱신 처리 한다.")    
    ...
    @ElDescription(sub = "연결된레포지토리브랜치 삭제처리", desc = "연결된레포지토리브랜치를 삭제 처리한다.")    

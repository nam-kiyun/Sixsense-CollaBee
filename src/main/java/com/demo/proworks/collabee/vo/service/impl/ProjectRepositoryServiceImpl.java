...
/**  
 * @subject     : 프로젝트와연결된레포지토리 관련 처리를 담당하는 ServiceImpl
 * @description	: 프로젝트와연결된레포지토리 관련 처리를 담당하는 ServiceImpl
 * @author      : 남기윤
 * @since       : 2025/07/01
 * @modification
 * ===========================================================
...
public class ProjectRepositoryServiceImpl implements ProjectRepositoryService {
     ...
     *
     * @process
     * 1. 프로젝트와연결된레포지토리 페이징 처리하여 목록을 조회한다.
     * 2. 결과 List<ProjectRepositoryVo>을(를) 리턴한다.
     * 
     * @param  projectRepositoryVo 프로젝트와연결된레포지토리 ProjectRepositoryVo
     * @return 프로젝트와연결된레포지토리 목록 List<ProjectRepositoryVo>
     * @throws Exception
     */
    ...
    /**
     * 조회한 프로젝트와연결된레포지토리 전체 카운트
     *
     * @process
     * 1. 프로젝트와연결된레포지토리 조회하여 전체 카운트를 리턴한다.
     * 
     * @param  projectRepositoryVo 프로젝트와연결된레포지토리 ProjectRepositoryVo
     * @return 프로젝트와연결된레포지토리 목록 전체 카운트
     * @throws Exception
     */
    ...
    /**
     * 프로젝트와연결된레포지토리를 상세 조회한다.
     *
     * @process
     * 1. 프로젝트와연결된레포지토리를 상세 조회한다.
    ...
    /**
     * 프로젝트와연결된레포지토리를 삭제 처리 한다.
     *
     * @process
     * 1. 프로젝트와연결된레포지토리를 삭제 처리 한다.
     * 
     * @param  projectRepositoryVo 프로젝트와연결된레포지토리 ProjectRepositoryVo
     * @return 번호
     * @throws Exception

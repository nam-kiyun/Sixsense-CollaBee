...
import com.demo.proworks.collabee.vo.vo.GithubAppTokenListVo;
...
/**  
 * @subject     : 깃허브앱토큰 관련 처리를 담당하는 컨트롤러
 * @description : 깃허브앱토큰 관련 처리를 담당하는 컨트롤러
 * @author      : 남기윤
 * @since       : 2025/07/01
 * @modification
 * ===========================================================
...
public class GithubAppTokenController {
    ...
    @ElDescription(sub="깃허브앱토큰 목록조회",desc="페이징을 처리하여 깃허브앱토큰 목록 조회를 한다.")               
    ...
    @ElDescription(sub = "깃허브앱토큰 갱신 폼을 위한 조회", desc = "깃허브앱토큰 갱신 폼을 위한 조회를 한다.")    
    ...
    @ElDescription(sub="깃허브앱토큰 등록처리",desc="깃허브앱토큰를 등록 처리 한다.")
    ...
    @ElDescription(sub="깃허브앱토큰 갱신처리",desc="깃허브앱토큰를 갱신 처리 한다.")    
    ...
    @ElDescription(sub = "깃허브앱토큰 삭제처리", desc = "깃허브앱토큰를 삭제 처리한다.")    

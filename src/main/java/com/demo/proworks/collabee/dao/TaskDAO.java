...
/**  
 * @subject     : 업무 관련 처리를 담당하는 DAO
 * @description : 업무 관련 처리를 담당하는 DAO
 * @author      : 남기윤
 * @since       : 2025/07/01
 * @modification
 * ===========================================================
...
public class TaskDAO extends com.demo.proworks.cmmn.dao.ProworksDefaultAbstractDAO {
    ...
    public TaskVo selectTask(TaskVo vo) throws ElException {
        return (TaskVo) selectByPk("com.demo.proworks.collabee.selectTask", vo);
    }

    /**
     * 페이징을 처리하여 업무 목록조회를 한다.
     *  
     * @param  TaskVo 업무
     * @return List<TaskVo> 업무
     * @throws ElException
     */
    public List<TaskVo> selectListTask(TaskVo vo) throws ElException {      	
        return (List<TaskVo>)list("com.demo.proworks.collabee.selectListTask", vo);
    }

    /**
     * 업무 목록 조회의 전체 카운트를 조회한다.
     *  
     * @param  TaskVo 업무
     * @return 업무 조회의 전체 카운트
     * @throws ElException
     */
    public long selectListCountTask(TaskVo vo)  throws ElException{               
        return (Long)selectByPk("com.demo.proworks.collabee.selectListCountTask", vo);
    }
    ...
    public int insertTask(TaskVo vo) throws ElException {    	
        return insert("com.demo.proworks.collabee.insertTask", vo);
    }
    ...
    public int updateTask(TaskVo vo) throws ElException {
        return update("com.demo.proworks.collabee.updateTask", vo);
    }
    ...
    public int deleteTask(TaskVo vo) throws ElException {
        return delete("com.demo.proworks.collabee.deleteTask", vo);
    }

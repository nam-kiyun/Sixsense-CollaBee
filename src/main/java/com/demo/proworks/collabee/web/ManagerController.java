...
import com.demo.proworks.collabee.vo.ManagerListVo;
...
/**  
 * @subject     : 업무 담당자 관련 처리를 담당하는 컨트롤러
 * @description : 업무 담당자 관련 처리를 담당하는 컨트롤러
 * @author      : 남기윤
 * @since       : 2025/07/01
 * @modification
 * ===========================================================
...
public class ManagerController {
    ...
    @ElDescription(sub="업무 담당자 목록조회",desc="페이징을 처리하여 업무 담당자 목록 조회를 한다.")               
    ...
    @ElDescription(sub = "업무 담당자 갱신 폼을 위한 조회", desc = "업무 담당자 갱신 폼을 위한 조회를 한다.")    
    ...
    @ElDescription(sub="업무 담당자 등록처리",desc="업무 담당자를 등록 처리 한다.")
    ...
    @ElDescription(sub="업무 담당자 갱신처리",desc="업무 담당자를 갱신 처리 한다.")    
    ...
    @ElDescription(sub = "업무 담당자 삭제처리", desc = "업무 담당자를 삭제 처리한다.")    

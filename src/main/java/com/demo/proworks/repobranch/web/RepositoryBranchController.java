...
import com.demo.proworks.repobranch.vo.RepositoryBranchListVo;
...
/**  
 * @subject     : 리포지토리 브랜치 정보 관련 처리를 담당하는 컨트롤러
 * @description : 리포지토리 브랜치 정보 관련 처리를 담당하는 컨트롤러
 * @author      : 남기윤
 * @since       : 2025/07/01
 * @modification
 * ===========================================================
...
public class RepositoryBranchController {
    ...
    @ElDescription(sub="리포지토리 브랜치 정보 목록조회",desc="페이징을 처리하여 리포지토리 브랜치 정보 목록 조회를 한다.")               
    ...
    @ElDescription(sub = "리포지토리 브랜치 정보 갱신 폼을 위한 조회", desc = "리포지토리 브랜치 정보 갱신 폼을 위한 조회를 한다.")    
    ...
    @ElDescription(sub="리포지토리 브랜치 정보 등록처리",desc="리포지토리 브랜치 정보를 등록 처리 한다.")
    ...
    @ElDescription(sub="리포지토리 브랜치 정보 갱신처리",desc="리포지토리 브랜치 정보를 갱신 처리 한다.")    
    ...
    @ElDescription(sub = "리포지토리 브랜치 정보 삭제처리", desc = "리포지토리 브랜치 정보를 삭제 처리한다.")    

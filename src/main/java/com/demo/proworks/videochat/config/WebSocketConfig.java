...
public class WebSocketConfig implements WebSocketConfigurer {
	...
	public void registerWebSocketHandlers(WebSocketHandlerRegistry registry) {
		...
		try {
			...
			registry.addHandler(kanbanWebSocketHandler, "/websocket/kanban").setAllowedOriginPatterns("*");
			System.out.println("✅ 칸반보드 WebSocket 등록 성공: /websocket/kanban");

			// 추가 경로로도 등록 (디버깅용)
			registry.addHandler(kanbanWebSocketHandler, "/kanban").setAllowedOriginPatterns("*");

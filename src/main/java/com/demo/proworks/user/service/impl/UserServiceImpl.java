...
public class UserServiceImpl implements UserService {
	 ...
	 * 사용자 정보 목록을 조회합니다.
	 *
	 * @process 1. 사용자 정보 페이징 처리하여 목록을 조회한다. 2. 결과 List<UserVo>을(를) 리턴한다.
	 * 
	 ...
	 * 조회한 사용자 정보 전체 카운트
	 *
	 * @process 1. 사용자 정보 조회하여 전체 카운트를 리턴한다.
	 * 
	 * @param userVo 사용자 정보 UserVo
	 ...
	 * 사용자 정보를 상세 조회한다.
	 *
	 * @process 1. 사용자 정보를 상세 조회한다. 2. 결과 UserVo을(를) 리턴한다.
	 * 
	 * @param userVo 사용자 정보 UserVo
	 * @return 단건 조회 결과
	 * @throws Exception
